...
if __name__=='__main__':
    model = LSKNet(embed_dims=[64, 128, 320, 512], drop_rate=0.1, drop_path_rate=0.1, depths=[2,2,4,2])
    # model.init_weights()
    # for key in model.state_dict().keys():
    #     if key == 'head.weight':
            # print(key)
    # y = torch.load('/home/lab6/ZZHSSDisk/zzh_DetGeo/lsk_s_backbone-e9d2e551.pth')['state_dict']
    # m = list(y.keys())
    # if 'head.weight' in m:
    #     print(111111)
    model.load_state_dict(torch.load('/home/lab6/ZZHSSDisk/zzh_DetGeo/lsk_s_backbone-e9d2e551.pth')['state_dict'],strict=False)
    model.cuda(0)
    x = torch.ones((2,3,1024,1024)).cuda(0)
